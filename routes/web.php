...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // --- DASHBOARD UTAMA (Statistik & Info Umum Semua Role) ---
    ...
    // =========================================================
    // Pengguna melihat detail pengajuannya, Admin juga bisa akses ini saat butuh
    Route::get('/permohonan/{id}/detail', [PermohonanController::class, 'show'])->name('permohonan.show');
    // Rute untuk mencetak Surat Perintah Jalan (Akses dicek di dalam Controller)
